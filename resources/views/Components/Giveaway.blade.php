...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row">
                <h1 class="m-0 font-weight-bold p-2 tabTitle">SHARE CAPITAL GIVEAWAY</h1>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
    <!-- /.content-header -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="giveawayForm" method="POST">
                    <input type="hidden" name="id">
                    <input type="hidden" name="category" value="sharecapital">
                    <div class="row">
                        <div class="col-6">
                            <label for="memid">Memid</label>
                            <div class="form-group">
                    ...
                    <div class="row shareCapitalContainer">
                        <div class="col-12">
                            <div class="card elevation-1 card-outline card-primary p-2">
                                <div class="row">
                                    <div class="col-7">
                                        <p class="font-weight-bold border p-1 mb-1">Share Capital: <b class="text-danger shareCapitalLabel"></b></p>
                                    </div>
                                    <div class="col-5">
